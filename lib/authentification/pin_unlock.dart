  ...
  Future<void> _authentifierParEmpreinte() async {
    ...
    try {
      ...
      if (authentifie && mounted) {
        // Réinitialiser les compteurs en cas de succès biométrique
        _tentatives = 0;
        _nbBlocages = 0;
        await _storage.write(key: 'nb_blocages_pin', value: '0');
        await _storage.write(key: 'tentatives_pin', value: '0');
...
// ═══════════════════════════════════════════════
// MODIFIER _Clavier POUR SUPPORTER L'ÉTAT DÉSACTIVÉ
// ═══════════════════════════════════════════════
...
// ═══════════════════════════════════════════════
// MODIFIER _AnimatedTouche POUR SUPPORTER L'ÉTAT DÉSACTIVÉ
// ═══════════════════════════════════════════════
